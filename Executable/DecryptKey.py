...
# Form implementation generated from reading ui file './UI/DecryptKey.ui'
#
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.textEdit.setPlaceholderText(_translate("MainWindow", "Enter the text which you want to decrypt"))
        self.pushButton.setText(_translate("MainWindow", "Decrypt"))
        self.label_2.setText(_translate("MainWindow", "OUTPUT"))
        self.textEdit_2.setPlaceholderText(_translate("MainWindow", "This will give the decrypted text"))
        ...
        self.textEdit_3.setPlaceholderText(_translate("MainWindow", "Enter the key that will be used for decrypting the string"))
