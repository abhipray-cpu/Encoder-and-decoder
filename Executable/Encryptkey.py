...
# Form implementation generated from reading ui file './UI/EncryptkeyUI.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textEdit.setGeometry(QtCore.QRect(70, 20, 441, 191))
        ...
        self.textEdit_3.setGeometry(QtCore.QRect(540, 20, 191, 181))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.textEdit.setPlaceholderText(_translate("MainWindow", "Enter the text which you want to encrypt"))
        self.pushButton.setText(_translate("MainWindow", "Encrypt"))
        self.label_2.setText(_translate("MainWindow", "OUTPUT"))
        self.textEdit_2.setPlaceholderText(_translate("MainWindow", "This will give the encryptd text"))
        ...
        self.textEdit_3.setPlaceholderText(_translate("MainWindow", "Enter the key that will be used for encrypting the string"))
